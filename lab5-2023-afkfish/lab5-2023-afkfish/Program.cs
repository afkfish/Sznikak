...
namespace lab5_2023_afkfish
{
    internal class Program
    {
        private const string cstring = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=JOYAXJ;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
